...
//        System.out.println(listWebElements);
    ...
    public void swipeUp(int timWeOfSwipe)
    {
    ...
    public String waitForElementAndGetAttribute(By by, String attribute, String error_message, long WaitOptions)
    {
        WebElement element = waitForElementPresent(by, error_message, WaitOptions);
